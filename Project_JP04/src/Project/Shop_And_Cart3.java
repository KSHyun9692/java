...
public class Shop_And_Cart3 extends JPanel implements ActionListener{
	private ImageIcon [] images = { new ImageIcon("images/13.jpg"), new ImageIcon("images/14.jpg"), new ImageIcon("images/15.jpg"),
			new ImageIcon("images/16.jpg"), new ImageIcon("images/17.jpg"), new ImageIcon("images/18.jpg")};
	...
	public Shop_And_Cart3(Frame_Start s, String currUser) {
		this.s = s;
