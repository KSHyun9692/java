...
public class Shop_And_Cart2 extends JPanel implements ActionListener{
	private ImageIcon [] images = { new ImageIcon("images/7.jpg"), new ImageIcon("images/8.jpg"), new ImageIcon("images/9.jpg"),
			new ImageIcon("images/10.jpg"), new ImageIcon("images/11.jpg"), new ImageIcon("images/12.jpg")};
	...
	public Shop_And_Cart2(Frame_Start s, String currUser) {
		this.s = s;
