...
public class Shop_And_Cart4 extends JPanel implements ActionListener{
	private ImageIcon [] images = { new ImageIcon("images/19.jpg"), new ImageIcon("images/20.jpg"), new ImageIcon("images/21.jpg"),
			new ImageIcon("images/21.jpg"), new ImageIcon("images/23.jpg"), new ImageIcon("images/24.jpg")};
	...
	public Shop_And_Cart4(Frame_Start s, String currUser) {
		this.s = s;
