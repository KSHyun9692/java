...
public class Shop_And_Cart5 extends JPanel implements ActionListener{
	private ImageIcon [] images = { new ImageIcon("images/25.jpg"), new ImageIcon("images/26.jpg"), new ImageIcon("images/27.jpg"),
			new ImageIcon("images/28.jpg"), new ImageIcon("images/29.jpg"), new ImageIcon("images/30.jpg")};
	...
	public Shop_And_Cart5(Frame_Start s, String currUser) {
		this.s = s;
